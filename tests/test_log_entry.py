...
from src.log_entry import LogEntry, BasicInfo, EventInfo, ErrorInfo, HttpInfo, TraceInfo
...
def test_log_entry_to_json():
    ...
    log_entry.basic.log_level_number = 70
    ...
    log_entry.http.http_request_method = "POST"
    log_entry.http.http_request_body_content = "{\"username\":\"johndoe\",\"password\":\"*****\"}"
    log_entry.http.http_response_status_code = 200
    log_entry.http.url_original = "https://api.example.com/login"

    log_entry.trace.trace_id = "trace-6789"
    log_entry.trace.span_id = "span-9876"

    log_entry.add_property("custom_key", "custom_value")
